...
public final class Randomly {
    ...
    public static String getCharacterVarying(int n) {
        if (n <= 0) {
            Random r = new Random();
            n = r.nextInt(DataTypePara.rdm_char_default_length_max) + 1;
        }
        Random r = new Random();
        int num = r.nextInt(n);
        //        String generatedString = RandomStringUtils.random(10, 0x4e00, 0x9fa5, true, true);
        return "varchar '" + RandomStringUtils.random(num, DataTypePara.rdm_char_start, DataTypePara.rdm_char_end, true, true) + "'";
    }

    public static String geCharacter(int n) {
        if (n <= 0) {
            Random r = new Random();
            n = r.nextInt(DataTypePara.rdm_char_default_length_max) + 1;
        }
        ...
        int num = r.nextInt(n);
//        String generatedString = RandomStringUtils.random(10, 0x4e00, 0x9fa5, true, true);
        return "'" + RandomStringUtils.random(num, DataTypePara.rdm_char_start, DataTypePara.rdm_char_end, true, true) + "'";
    }

    public static String getText() {
        Random r = new Random();
        int num = r.nextInt(DataTypePara.rdm_text_length_max);
        String generatedString = RandomStringUtils.random(num, DataTypePara.rdm_char_start, DataTypePara.rdm_char_end, true, true);
//        String generatedString = RandomStringUtils.randomAlphabetic(10);
    ...
    public static String getIntegerType() {
        Random r = new Random();
        int num = r.nextInt(DataTypePara.rdm_int_max);
        return String.valueOf(num);
    }
    ...
    // Uncritical
    public static String getNumeric(int p, int s) {
        if (!(p > 0 && s >= 0)) {
            Random r = new Random();
            return String.valueOf(r.nextDouble() * Math.pow(10, r.nextInt(DataTypePara.rdm_numeric_default_power_max)));
        }
        Random r = new Random();
        int num = 0;
        StringBuilder sb = new StringBuilder();
    ...
    public static String getBytea() {
        Random r = new Random();
        StringBuilder sb = new StringBuilder("bytea '/x");
        for (int i = 2 * r.nextInt(DataTypePara.rdm_byyea_length_max); i >= 0; i--) {
    ...
    public static String getNumberString(){
        StringBuilder sb = new StringBuilder("'");
        int num1 = Math.negateExact((new Random().nextInt(100)));
        sb.append(num1);
        sb.append("'");
        return sb.toString();
    }
    ...
    public static String getTimestamp(int p) {
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        Random r = new Random();
        LongStream longs = r.longs(1, 0, DataTypePara.rdm_time_bound);
        Date randomTime = new Date(longs.toArray()[0]);
        return "TIMESTAMP '" + sdf.format(randomTime) + "'";
    }

    public static String getTimestampWithTimeZone(int p) {
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        Random r = new Random();
        LongStream longs = r.longs(1, 0, DataTypePara.rdm_time_bound);
        Date randomTime = new Date(longs.toArray()[0]);
    ...
    public static String getTimeWithTimeZone(int p) {
        SimpleDateFormat sdf = new SimpleDateFormat("HH:mm:ss");
        Random r = new Random();
        LongStream longs = r.longs(1, 0, DataTypePara.rdm_time_bound);
        Date randomTime = new Date(longs.toArray()[0]);
    ...
    public static String getInterval(int p) {
        Random r = new Random();

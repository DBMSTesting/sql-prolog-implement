...
public final class TiDBSetGenerator {
    ...
    private enum Action {
        ...
        TIDB_OPT_JOIN_REORDER_THRESHOLD("tidb_opt_join_reorder_threshold", (r) -> Randomly.fromOptions(0, 1)),
        TIDB_ENABLE_INDEX_MERGE("tidb_enable_index_merge",(r) -> Randomly.fromOptions(0, 1)),

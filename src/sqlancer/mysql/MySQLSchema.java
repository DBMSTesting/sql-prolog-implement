...
public class MySQLSchema extends AbstractSchema<MySQLGlobalState, MySQLTable> {
    ...
    public enum MySQLDataType {
        ...
        INT, VARCHAR, FLOAT, DOUBLE, DECIMAL,TINYINT, SMALLINT, MEDIUMINT, BIGINT,TINYTEXT, TEXT, MEDIUMTEXT, LONGTEXT,UNSIGNED,ZEROFILL;
        ...
        public static MySQLDataType getRandom(MySQLGlobalState globalState) {
            if (globalState.usesPQS()) {
                ...
                return Randomly.fromOptions(MySQLDataType.INT, MySQLDataType.VARCHAR,MySQLDataType.FLOAT,MySQLDataType.DOUBLE,MySQLDataType.DECIMAL);
            }
        }
        ...
        public String getValue(MySQLDataType type) {

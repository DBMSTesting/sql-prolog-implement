...
//         },
        ...
        MOD(2,"MOD"){
            ...
            public MySQLConstant apply(MySQLConstant[] args, MySQLExpression... origArgs){
                ...
                long intVal1 = args[0].castAs(CastType.SIGNED).getInt();
                long intVal2 = args[1].castAs(CastType.SIGNED).getInt();
                return MySQLConstant.createIntConstant(Math.floorMod(intVal1,intVal2));
            }
        },
        LEAST(2, "LEAST", true) {

...
public class MySQLBinaryComparisonCheckOperation implements MySQLExpression{
    public enum BinaryComparisonCheckOperator {
        EQUALS("=") {
            @Override
        ...
        NOT_EQUALS("!=") {
            ...
            public MySQLConstant getExpectedValue(MySQLConstant leftVal, MySQLConstant rightVal) {
                ...
                if (isEquals.getType() == MySQLSchema.MySQLDataType.INT) {
        ...
        LESS_EQUALS("<=") {
            ...
            public MySQLConstant getExpectedValue(MySQLConstant leftVal, MySQLConstant rightVal) {
                ...
                if (lessThan.getType() == MySQLSchema.MySQLDataType.INT && lessThan.getInt() == 0) {
                    return leftVal.isEquals(rightVal);
                } else {
                    return lessThan;
                }
        ...
        GREATER(">") {
            ...
            public MySQLConstant getExpectedValue(MySQLConstant leftVal, MySQLConstant rightVal) {
                ...
                if (equals.getType() == MySQLSchema.MySQLDataType.INT && equals.getInt() == 1) {
                    ...
                    return MySQLUnaryPrefixOperation.MySQLUnaryPrefixOperator.NOT.applyNotNull(applyLess);
                }
            }
        },
        GREATER_EQUALS(">=") {
...
//        };
        ...
        BinaryComparisonCheckOperator(String textRepresentation) {
            this.textRepresentation = textRepresentation;
        }

        public abstract MySQLConstant getExpectedValue(MySQLConstant leftVal, MySQLConstant rightVal);

        public static MySQLBinaryComparisonCheckOperation.BinaryComparisonCheckOperator getRandom() {
            return Randomly.fromOptions(MySQLBinaryComparisonCheckOperation.BinaryComparisonCheckOperator.values());
        }
    ...
    private final MySQLBinaryComparisonCheckOperation.BinaryComparisonCheckOperator op;
    private final String subquery;

    public MySQLBinaryComparisonCheckOperation(MySQLExpression left, MySQLExpression right, MySQLBinaryComparisonCheckOperation.BinaryComparisonCheckOperator op, String subquery) {
        this.left = left;
        this.right = right;
        this.op = op;
    ...
    public MySQLBinaryComparisonCheckOperation.BinaryComparisonCheckOperator getOp() {
        return op;
    }

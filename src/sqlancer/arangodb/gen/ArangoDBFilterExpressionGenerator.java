...
public class ArangoDBFilterExpressionGenerator
    ...
    @Override
    protected Node<ArangoDBExpression> generateExpression(int depth,String currentCov) {
        ...
        case BINARY_COMPARISON:
            ...
            return new NewBinaryOperatorNode<>(generateExpression(depth + 1,""), generateExpression(depth + 1,""), op,null);
        case UNARY_PREFIX:

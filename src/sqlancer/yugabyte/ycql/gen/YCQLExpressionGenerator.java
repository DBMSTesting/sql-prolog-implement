...
public final class YCQLExpressionGenerator extends UntypedExpressionGenerator<Node<YCQLExpression>, YCQLColumn> {
    ...
    @Override
    protected Node<YCQLExpression> generateExpression(int depth,String currentCov) {
        ...
        case BINARY_ARITHMETIC:
            return new NewBinaryOperatorNode<YCQLExpression>(generateExpression(depth + 1,""),
                    generateExpression(depth + 1,""), YCQLBinaryArithmeticOperator.getRandom(),null);
        case FUNC:
    ...
    @Override
    public List<Node<YCQLExpression>> generateOrderBys(String currentCov) {

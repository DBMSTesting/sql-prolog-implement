...
public class SQLite3ColumnBuilder {
    ...
    public String createColumn(String columnName, SQLite3GlobalState globalState, List<SQLite3Column> columns,List<String> columnConstrain,List<String> columnConstrainContent) {
...
//                        }
        ...
        if (allowDefaultValue && Randomly.getBooleanWithSmallProbability()) {
            sb.append(" DEFAULT ");
            String defaultStr = SQLite3Visitor.asString(SQLite3ExpressionGenerator.getRandomLiteralValue(globalState));

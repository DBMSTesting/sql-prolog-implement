...
public abstract class TernaryLogicPartitioningOracleBase<E, S extends GlobalState<?, ?, ?>> implements TestOracle<S> {
    ...
    protected E generatePredicate(String currentCov) {
        return getGen().generatePredicate(currentCov);
    }

    public void initializeTernaryPredicateVariants(String currentCov) {

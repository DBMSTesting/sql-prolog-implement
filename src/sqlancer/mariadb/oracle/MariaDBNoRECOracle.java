...
public class MariaDBNoRECOracle extends NoRECBase<MariaDBGlobalState> implements TestOracle<MariaDBGlobalState> {
    ...
    public static MariaDBSelectStatement subquery;
    ...
    public void check() throws SQLException {
        ...
        MariaDBExpressionGenerator gen1 = new MariaDBExpressionGenerator(state.getRandomly()).setColumns(columns)
                .setCon(con).setState(state.getState());
        MariaDBExpression randomWhereCondition1 = gen1.getRandomExpression();
        ...
        subquery.setFetchColumns(Arrays.asList(aggr));
        subquery.setFromTables(Arrays.asList(randomTable));
        subquery.setWhereClause(randomWhereCondition1);
        subquery.setSelectType(MariaDBSelectType.ALL);

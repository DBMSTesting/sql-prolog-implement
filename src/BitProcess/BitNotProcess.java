...
public class BitNotProcess {
    public static String bitNotProcess(String keyword , List<TreeNode> childs, TreeValue treeValue) throws IOException {
        if(childs.size()==1){
            String parameter1 ="";
            ...
            return bitNot(keyword,parameter1,treeValue.keywordResult,treeValue.parameter);
        }else{
            return "参数错误";
        }
    }
    public static String bitNot(String keyword,String x,String tempResult,String column) throws IOException {
        Process p;
...
//        }
        ...
        out.write(("['"+ ScriptPrologCommandOrLogic.prologMainFile+"/Bit/bit_not.pl'].\n").getBytes());

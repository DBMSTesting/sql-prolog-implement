...
public class GreaterOrEqualProcess {
    public static String greaterOrEqualProcess(List<ASTStructure.TreeNode> childs, TreeValue treeValue) throws IOException {
        if (childs.size() == 2) {
            String parameter1 ="";
            ...
            return bigequal(parameter1, parameter2, treeValue.keywordResult, treeValue.parameter);
        } else {
            return "参数错误";
        }
    }
...
//        }
        ...
        out.write(("['" + ScriptPrologCommandOrLogic.prologMainFile + "/Condition/bigequal.pl'].\n").getBytes());

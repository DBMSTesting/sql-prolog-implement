...
public class NotEqualProcess {
    public static String notEqualProcess(List<TreeNode> childs, TreeValue treeValue) throws IOException {
        if(childs.size()==2){
            String parameter1 ="";
            ...
            return notEqual(parameter1,parameter2,treeValue.keywordResult,treeValue.parameter);
        }else{
            return "参数错误";
        }
    }
...
//        }
        ...
        out.write(("['"+ ScriptPrologCommandOrLogic.prologMainFile+"/Condition/notequal.pl'].\n").getBytes());

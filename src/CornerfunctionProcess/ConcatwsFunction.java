...
public class ConcatwsFunction {
    public static String concatwsProcess(List<TreeNode> childs, TreeValue treeValue) throws IOException {
        if(childs.size()==1){
            String parameter1 ="";
            ...
            return concatws(parameter1,treeValue.keywordResult,treeValue.parameter);
        }else{
            return "参数错误";
        }
    }
    public static String concatws(String y,String tempResult,String column) throws IOException {
        Process p;
        ...
        out.write(("['"+ ScriptPrologCommandOrLogic.prologMainFile+"/Cornor_function/concat_ws.pl'].\n").getBytes());
        out.write(("concatws_clause("+str+",Z).\n").getBytes());
        System.out.println("concatws_clause("+str+",Z).");
        out.flush();
        out.close();
        String line;

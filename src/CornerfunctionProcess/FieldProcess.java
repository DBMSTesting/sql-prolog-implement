...
public class FieldProcess {
    public static String fieldProcess(List<TreeNode> childs, TreeValue treeValue) throws IOException {
        if(childs.size()==1){
            String parameter1 ="";
            ...
            return field(parameter1,treeValue.keywordResult,treeValue.parameter);
        }else{
            return "参数错误";
        }
    }
    public static String field(String y,String tempResult,String column) throws IOException {
        Process p;
        ...
        out.write(("['"+ ScriptPrologCommandOrLogic.prologMainFile+"/Cornor_function/field.pl'].\n").getBytes());
        out.write(("field_clause("+str+",Z).\n").getBytes());
        System.out.println("field_clause("+str+",Z).");
        out.flush();
        out.close();
        String line;
